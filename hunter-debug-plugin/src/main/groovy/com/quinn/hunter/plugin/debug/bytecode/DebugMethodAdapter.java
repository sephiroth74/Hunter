...
public final class DebugMethodAdapter extends LocalVariablesSorter implements Opcodes {
    ...
    public void visitCode() {
        ...
        mv.visitLdcInsn(method.getDebugArguments());
        mv.visitMethodInsn(
                INVOKESPECIAL, Constants.PARAM_PRINTER_CLASS, "<init>", "(Ljava/lang/String;Ljava/lang/String;I)V", false);
    ...
    public void visitInsn(int opcode) {
        if (method.isDebugOutput() && debugMethod && ((opcode >= IRETURN && opcode <= RETURN) || opcode == ATHROW)) {
            ...
            if (returnType != Type.VOID_TYPE || opcode == ATHROW) {
                ...
                String formatDesc = String.format("(IILjava/lang/String;Ljava/lang/String;J%s)V", returnDesc);
